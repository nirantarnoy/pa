...
/* @var $searchModel backend\models\ReqtelephoneSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'แจ้งปัญหาโทรศัพท์';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="reqtelephone-index">

    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <p>
        <?php //echo Html::a('Create Reqtelephone', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
...
//}
       ...
       alert(recid);
        $.ajax({
            ...
            dataType: "json",
            url: Url,
            data:{pk: recid , module: "telephone"},
