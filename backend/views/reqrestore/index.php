...
/* @var $searchModel backend\models\ReqstoreSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'ร้องขอกู้คืนข้อมูล';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="reqstore-index">

    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <p>
        <?php //echo Html::a('Create Reqstore', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    <?php    Modal::begin([
         'header' => 'ทำรายการ',
                'id' => 'modal',
