...
/* @var $searchModel backend\models\ReqcameraSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'แจ้งปัญหากล้องวงจรปิด';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="reqcamera-index">

    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

<div class="departmentjob"  <?php echo "id=".$session['department']; ?>></div>
    <p>
        <?php //echo Html::a('Create Reqcamera', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
...
var dept = $(".departmentjob").attr("id");
      ...
      // alert(recid);
        $.ajax({
            ...
            dataType: "json",
            url: Url,
            data:{pk: recid , module: "camera", department: dept },
